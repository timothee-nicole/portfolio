        ...
        <div className="profile">
            ...
            :
                <div>
                    ...
                    Ayant grandi dans une famille d'entrepreneur, j'ai toujours voulu créé ma propre entreprise. Après ma formation en Master entrepreneuriat à l'ESSCA, je me suis rendu compte que dans l'environnement des start-ups, un créateur d'entreprise a besoin d'avoir des compétences techniques sur les nouvelles technologies web. C'est pourquoi j'ai décidé de rejoindre le Bootcamp de IronHack pour apprendre autant le développement back-end et le développement front-end. Pendant ce bootcamp je me suis vite rendu compte de la puissance et du coté sympa des languages de programmation comme JavaScript. Aussi je continue d'être surpris par ce language avec le temps qui passe.</p>
